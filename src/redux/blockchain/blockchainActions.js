                ...
                if (networkId === '4' || networkId === 4) {
                    ...
                    if (register) {
                        web3.eth.getBalance(account, async (err, result) => {
                            ...
                            const response = await axios.post('https://raffle.m3tamoguls.com/', body)
                        ...
                        const response = await axios.post('https://raffle.m3tamoguls.com/', {address:account})
...
export const checkRuffle = () => {
    return async (dispatch) => {
        const response = await axios.post('https://raffle.m3tamoguls.com/?checkRuffle=true', {checkRuffle: true})
